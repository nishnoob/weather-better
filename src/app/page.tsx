...
const App: React.FC = () => {
  ...
  return (
    <div className='relative'>    
      <div className="flex items-center justify-center min-h-screen bg-transparent z-20 absolute left-0 top-0 w-screen h-screen">
      ...
      {true && 
          <div className='relative top-0 w-screen h-screen z-10'>
            <Rain />
          </div>
        }
    </div>
